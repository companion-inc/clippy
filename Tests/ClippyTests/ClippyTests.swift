...
@Test func onboardingDemoPreparesLocalPageArtifact() throws {
    ...
    #expect(html.contains("Quick request"))
    ...
    #expect(html.contains("local demo page"))
    ...
    #expect(html.localizedCaseInsensitiveContains("drawing goes") == false)
    #expect(html.contains("/Users/") == false)
    #expect(ClippyOnboardingDemo.guidedIntroText.contains("fill out a small form"))
    #expect(ClippyOnboardingDemo.guidedIntroText.contains("save it"))
    #expect(ClippyOnboardingDemo.guidedIntroText.contains("point to the field"))
    ...
    #expect(ClippyOnboardingDemo.guidedWorkingText == "Trying the form")
...
@Test func onboardingResumePointParsesSavedStepAndFallsBackToWelcome() {
    ...
    #expect(ClippyOnboardingResumePoint.savedPoint(from: "permission") == .screenHelp)
    #expect(ClippyOnboardingResumePoint.savedPoint(from: "permissionWalkthrough") == .screenHelp)
    #expect(ClippyOnboardingResumePoint.savedPoint(from: "demoComposer") == .demo)
    #expect(ClippyOnboardingResumePoint.allCases.contains(.screenHelp))
    #expect(ClippyOnboardingResumePoint.allCases.contains(.fileAccess))
