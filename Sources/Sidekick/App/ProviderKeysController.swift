...
final class ProviderKeysController: NSWindowController {
    ...
    private func loadExistingKeys() {
        sttField.stringValue = SidekickSecrets.deepgramAPIKey ?? ""
        ttsField.stringValue = SidekickSecrets.xaiAPIKey ?? ""
    }

    private func saveKeys() {
        do {
            try SidekickSecrets.saveVoiceAPIKeys(
...
private final class APIKeyPanel: NSView {
    ...
    private func build() {
        addSubview(APIKeyTitleBar(title: "Sidekick - Configure API Key"))
