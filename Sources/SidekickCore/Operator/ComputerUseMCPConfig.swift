...
public enum ComputerUseMCPConfig {
    public static let bundledHelperName = "SidekickComputerUseRuntime"
    ...
    public static func defaultRuntime(
        ...
        let candidates: [(serverName: String, command: String, args: [String], enabledTools: [String])] = [
            ...
            ("cua-driver", environment["SIDEKICK_CUA_DRIVER"] ?? environment["CLIPPY_CUA_DRIVER"] ?? "", args, cuaDriverEnabledTools),
