...
public extension CredentialCatalog {
    ...
    static let clippyAuthPath = "/Users/advaitpaliwal/Library/Application Support/Clippy/CodexHome/auth.json"
    ...
    static let defaultDescriptors: [CredentialDescriptor] = [
        ...
        CredentialDescriptor(
            ...
            sources: [
                ...
                CredentialSourceDescriptor(kind: .clippyAuthJSON, path: clippyAuthPath, keyPath: "OPENAI_API_KEY"),
            ]
        ),
        CredentialDescriptor(
            provider: .xAI,
