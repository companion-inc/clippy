...
/// Sidekick's spoken replies via xAI Grok TTS.
///
...
public final class XAITTS {
    ...
    private let stateQueue = DispatchQueue(label: "sidekick.xai.tts")
    ...
    public init?(voiceID: String = SidekickVoice.default.id) {
        guard let key = SidekickSecrets.xaiAPIKey else { return nil }
        self.apiKey = key
