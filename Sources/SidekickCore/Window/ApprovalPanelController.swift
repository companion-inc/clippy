...
public final class ApprovalPanelController: NSObject {
    ...
    private final class PixelChoiceButton: NSButton {
        init(frame frameRect: NSRect, spec: SidekickBalloonSpec) {
            ...
            font = SidekickBalloonStyle.font(12, spec: spec)
    ...
    private func relayout() {
        ...
        balloonLayer.path = SidekickBalloonStyle.path(size: rootView.bounds.size, spec: spec.balloon)
