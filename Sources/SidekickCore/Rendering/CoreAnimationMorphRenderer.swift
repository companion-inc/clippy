...
/// Sidekick's original vector body: a paperclip character drawn entirely with
...
public final class CoreAnimationMorphRenderer {
    ...
    public init() {
        ...
        // Sway pivots around the lower body, like the sprite Clippy.
    ...
    /// back later — the modern equivalent of Clippy's shape-shifting frames.
    ...
    public func performNamedGesture() {
