...
public final class SpriteKitRasterCharacterRenderer {
    ...
    public func show(animationName: String, spriteSheet: SidekickSpriteSheet) throws {
    ...
    public func play(animationName: String, spriteSheet: SidekickSpriteSheet) throws {
