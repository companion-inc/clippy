...
public struct DesktopContextSnapshot: Equatable, Sendable {
    ...
    public var promptBlock: String {
        ...
        if let screen {
            ...
            lines.append("- screenshot target screen: fallback to Clippy's display")
        }
        lines.append("Clippy-owned windows are ignored when possible; use this for app/window/title/url context and the screenshot below for pixels.]")
    ...
    private static let browserResultSeparator = "|||CLIPPY_BROWSER_URL|||"
