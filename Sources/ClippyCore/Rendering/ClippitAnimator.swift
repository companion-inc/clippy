...
/// Frame stepper for Clippit-compatible animations, implemented with the Clippy animation
...
@MainActor
public final class ClippitAnimator {
    ...
    public var soundBank: ClippitSoundBank?

    private let sheet: ClippitSpriteSheet
    ...
    public init(sheet: ClippitSpriteSheet, renderer: SpriteKitRasterCharacterRenderer) {
        self.sheet = sheet
