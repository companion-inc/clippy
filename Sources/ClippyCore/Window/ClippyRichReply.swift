...
public struct ClippyRichReply: Equatable, Sendable {
    ...
    public static func parse(_ rawText: String) -> ClippyRichReply {
        let text = rawText.trimmingCharacters(in: .whitespacesAndNewlines)
        guard text.isEmpty == false else {
            return ClippyRichReply(text: "")
        }
        ...
        return ClippyRichReply(text: displayText, imageCards: imageCards, citations: citations)
    }
