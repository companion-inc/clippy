...
enum ClippyAnnotationMCP {
    ...
    private static func handle(_ request: [String: Any]) {
        ...
        case "initialize":
            send(id: id, result: [
                ...
                "serverInfo": ["name": "clippy-annotation", "version": "0.1.0"],
            ])
    ...
    private static func callTool(id: JSONValue, params: [String: Any]) {
        ...
        do {
            ...
            case "annotate":
                ...
                sendToolText(id: id, "Queued Clippy annotation.")
            case "clear_annotations":
                try appendCommand("clearground")
                sendToolText(id: id, "Cleared Clippy annotations.")
            default:
    ...
    private static func appendCommand(_ command: String) throws {
        let path = ProcessInfo.processInfo.environment["CLIPPY_CMD_FILE"] ?? defaultCommandFilePath()
    ...
    private static func defaultCommandFilePath() -> String {
        ...
        return base.appendingPathComponent("Clippy", isDirectory: true).appendingPathComponent("cmd.txt").path
    }
    ...
    private static let tools: [[String: Any]] = [
        ...
        [
            ...
            "description": "Clear Clippy's annotation overlay.",
            "inputSchema": [
                "type": "object",
                "additionalProperties": false,
                "properties": [:],
